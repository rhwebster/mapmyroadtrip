...
yellowstone = Trip(title='Yellowstone and Back Again', user_id=simon['id'],  start_date='2020-08-09', end_date=null, start_lat=40.712776, start_lon=-74.005974, end_lat=45.045200, end_lon=-110.521767, private=False)
grand_canyon = Trip(title='Grand Canyon Birthday', user_id=daphne['id'],  start_date=' 2020-09-27', end_date=null, start_lat=37.769893, start_lon=-122.421123, end_lat=36.106964, end_lon=-112.112999, private=False)
route66 = Trip(title='Haunted Route 66', user_id=simon['id'],  start_date='2020-04-14', end_date=null, start_lat=40.712776, start_lon=-74.005974, end_lat=35.0820877, end_lon=-106.9566669, private=True)
