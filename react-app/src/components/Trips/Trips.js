...
import { getTrips } from '../../store/getTrip';
...
export default function Trips() {
  ...
  const trips = useSelector(fullReduxState => {
    return fullReduxState.trips;
  })

  const lastTrip = trips[trips.length-1]
  const secondTrip = trips[trips.length-2]
          ...
          <ul class="trips">
            <li class="trips__item">
              <a class="trips__link focus--box-shadow" href="#">
                ...
                <p class="trips__name">{lastTrip.title}</p>
            ...
            <li class="trips__item">
              <a class="trips__link focus--box-shadow" href="#">
                ...
                <div class="trips__inform">
                  <p class="trips__name">{secondTrip.title}</p>
                  <time class="date" datetime="2020-05-05T10:00:00">
